...
var text1 = string("Wood Per Click: " + string(power(2,global.woodBaseLevel)*global.resourceBase*(global.upgradeWoodClick+1))+"      Wood Per Second: "+string(power(2,global.woodBaseLevel)*global.resourceBase*(global.upgradeWoodGen+1)));
draw_text(x,y,text1);
var text2 = string(" Wood Click Level: " + string(global.upgradeWoodClick+1) + "        Wood Generation level: " + string(global.upgradeWoodGen+1));
draw_text(x,y+120,text2)
var text3 = string("Wood Multiplier: " + string(power(2,global.woodBaseLevel)));
